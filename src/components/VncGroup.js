...
function VncGroup({ 
    ...
    // As outras funções (handleConnectionAdded, handleSaveConnection) permanecem as mesmas
    ...
    return (
        <div className="group-container">
                    ...
                    {isEditing && isEditModeEnabled ? (
                        <form onSubmit={handleSaveGroupName} style={{ width: '100%' }}>
                            <input
                                ...
                                onBlur={handleSaveGroupName} // Salva ao perder o foco
                                onKeyDown={(e) => e.key === 'Escape' && onCancelEdit()} // Cancela com a tecla Esc
                ...
                {isEditModeEnabled && (
                    <div className="group-actions">
                        {isEditing ? (
                            ...
                            <>
                                <button className="action-button-icon add" title="Adicionar Conexão VNC" onClick={() => setIsAddingConnection(!isAddingConnection)}><AddIcon /></button>
            ...
            {/* O resto do componente não precisa de grandes mudanças */}
